...
// Common copy functions of server for mavros_msgs/SetModeResponse
...
namespace SetMode_Response {
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::SetMode::Response& msg, const matlab::data::StructArray arr) {
    try {
        //mode_sent
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::SetMode::Response& msg) {
