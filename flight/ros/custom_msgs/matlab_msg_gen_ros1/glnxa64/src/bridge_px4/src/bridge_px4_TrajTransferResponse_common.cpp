...
// Common copy functions for bridge_px4/TrajTransferResponse
...
namespace TrajTransferResponse {
  //----------------------------------------------------------------------------
  BRIDGE_PX4_EXPORT void copy_from_arr(boost::shared_ptr<bridge_px4::TrajTransferResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //checksum
  ...
  //----------------------------------------------------------------------------
  BRIDGE_PX4_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const bridge_px4::TrajTransferResponse>& msg) {
