...
// Service Server for mavros_msgs/CommandBoolResponse
...
MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const mavros_msgs::CommandBool::Request& request);
} // namespace CommandBool_Request
} // namespace matlabhelper
} // namespace mavros_msgs
namespace mavros_msgs {
...
MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::CommandBool::Response& response,
                                          const matlab::data::StructArray arr);
} // namespace CommandBool_Response
} // namespace matlabhelper
} // namespace mavros_msgs
class MAVROS_MSGS_EXPORT mavros_msgs_srv_CommandBool_server
    : public MATLABSvcServerInterface {
    mavros_msgs::CommandBool::Response mResponse;
    void* mSd;
    SendDataToMATLABFunc_T mSendDataToMATLABFunc;
    intptr_t mHSvcServer;
    bool callback(mavros_msgs::CommandBool::Request& req,
                  mavros_msgs::CommandBool::Response& res) {
        auto outArray = mavros_msgs::matlabhelper::CommandBool_Request::get_arr(mFactory, req);
        if (mSd != NULL) {
  ...
  public:
    mavros_msgs_srv_CommandBool_server()
    ...
    virtual ~mavros_msgs_srv_CommandBool_server() {
    }
    virtual bool setResponseFromMatlab(matlab::data::Array arr) {
        mavros_msgs::matlabhelper::CommandBool_Response::copy_from_arr(mResponse, arr);
        return true;
    }
    virtual intptr_t createSvcServer(const std::string& svc_name,
        ...
        mSvc = std::make_shared<ros::ServiceServer>(theNode->advertiseService(
            svc_name, &mavros_msgs_srv_CommandBool_server::callback, this));
...
CLASS_LOADER_REGISTER_CLASS(mavros_msgs_srv_CommandBool_server, MATLABSvcServerInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
