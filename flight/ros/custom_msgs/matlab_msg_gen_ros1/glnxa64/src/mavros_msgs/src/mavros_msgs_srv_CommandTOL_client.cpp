...
// Service Client for mavros_msgs/CommandTOLRequest
...
MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::CommandTOL::Request& request,
...
namespace mavros_msgs {
namespace matlabhelper {
namespace CommandTOL_Response {
MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const mavros_msgs::CommandTOL::Response& response);
} // namespace CommandTOL_Response
} // namespace matlabhelper
} // namespace mavros_msgs
class MAVROS_MSGS_EXPORT mavros_msgs_srv_CommandTOL_client
    ...
    std::map<int64_t, mavros_msgs::CommandTOL::Request> mRequestPool;
    mavros_msgs::CommandTOL::Request mNextRequest;
  public:
    mavros_msgs_srv_CommandTOL_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~mavros_msgs_srv_CommandTOL_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<mavros_msgs::CommandTOL>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        if (ret) {
            ...
            auto outArray =
                mavros_msgs::matlabhelper::CommandTOL_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        ...
        mavros_msgs::matlabhelper::CommandTOL_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {mavros_msgs::matlabhelper::CommandTOL_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(mavros_msgs_srv_CommandTOL_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
