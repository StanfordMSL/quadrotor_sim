...
// Common copy functions of server for mavros_msgs/CommandTOLResponse
...
namespace CommandTOL_Response {
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::CommandTOL::Response& msg, const matlab::data::StructArray arr) {
    try {
        //success
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::CommandTOL::Response& msg) {
