...
namespace Thrust {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::Thrust::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::Thrust>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::Thrust>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","thrust"});
    // header
