...
% Raw Extract
raw_att_act = csvread('misc/actual_flight_data/FlightTest01/20_26_15_vehicle_attitude_0.csv',1,0);
raw_pos_act = csvread('misc/actual_flight_data/FlightTest01/20_26_15_vehicle_local_position_0.csv',1,0);
raw_br_act  = csvread('misc/actual_flight_data/FlightTest01/20_26_15_vehicle_angular_velocity_0.csv',1,0);
raw_br_sp  = csvread('misc/actual_flight_data/FlightTest01/20_26_15_vehicle_rates_setpoint_0.csv',1,0);
...
for k = 1:size(traj.u_br,2)
    if traj.u_br(1,k) < 0.01
%         traj.u_br(1,k) = 0.3077;
